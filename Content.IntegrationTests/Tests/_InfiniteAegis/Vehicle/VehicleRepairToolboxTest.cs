...
[TestFixture]
[TestOf(typeof(VehicleRepairToolboxSystem))]
public sealed class VehicleRepairToolboxTest : GameTest
{
    ...
    public async Task ToolboxRepairsAndConsumesCharges()
    {
        ...
        await server.WaitPost(() =>
        {
            ...
            toolbox = entityManager.SpawnEntity("VehicleRepairToolbox", map.MapCoords);
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var toolboxComponent = entityManager.GetComponent<VehicleRepairToolboxComponent>(toolbox);
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(VehicleRepairToolboxSystem.CalculateRepairAmount(450f, 500f), Is.EqualTo(100f));
                Assert.That(VehicleRepairToolboxSystem.CalculateRepairAmount(1000f, 500f), Is.EqualTo(600f));
            });
    ...
    private static void RaiseRepairEvent(
        ...
        EntityUid user)
    {
        var repairEvent = new VehicleRepairDoAfterEvent();
