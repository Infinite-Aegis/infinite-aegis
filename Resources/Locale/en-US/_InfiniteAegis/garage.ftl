ent-ParkingLotSpawnPoint = parking lot spawn point
    .desc = A map marker used to deliver a character's vehicle.

garage-action-name = Garage
...
garage-call-failed = The vehicle could not be delivered.
